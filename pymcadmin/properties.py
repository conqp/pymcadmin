...
class _ConfigParser(ConfigParser):
    ...
    def _read(self, fp: IO, fpname: str) -> None:
        """Reads a single file."""
        return super()._read(StringIO(f'[{PSEUDO_SECTION}]\n{fp.read()}'),
                             fpname)
...
class PropertiesParser:
    ...
    def __getitem__(self, key: str) -> str:
        return self.parser[PSEUDO_SECTION][key]

    def __setitem__(self, key: str, value: Any) -> None:
        self.parser[PSEUDO_SECTION][key] = value

    def get(self, key: str, **kwargs) -> str:
        """Returns the value of the respective key."""
        return self.parser.get(PSEUDO_SECTION, key, **kwargs)

    def getint(self, key: str, **kwargs) -> int:
        """Returns an integer value."""
        return self.parser.getint(PSEUDO_SECTION, key, **kwargs)

    def getfloat(self, key: str, **kwargs) -> float:
        """Returns an float value."""
        return self.parser.getfloat(PSEUDO_SECTION, key, **kwargs)

    def getboolean(self, key: str, **kwargs) -> bool:
        """Returns an boolean value."""
        return self.parser.getboolean(PSEUDO_SECTION, key, **kwargs)

    def set(self, key: str, value: Optional[Any] = None) -> None:
        """Sets a value."""
        return self.parser.set(PSEUDO_SECTION, key, value)
